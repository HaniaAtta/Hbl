...
fig5, ax5 = plt.subplots(figsize=(6, 3))  # Adjusted plot size
sns.boxplot(
...
if 'Time' in data.columns:
    ...
    if not data.empty:
        ...
        if not time_series.empty:
            fig6, ax6 = plt.subplots(figsize=(6, 3))  # Adjusted plot size
...
fig7, ax7 = plt.subplots(figsize=(6, 3))  # Adjusted plot size
