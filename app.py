...
fig2, ax2 = plt.subplots(figsize=(4, 3))  # Adjusted plot size
...
fig3, ax3 = plt.subplots(figsize=(5, 3))  # Adjusted plot size
...
fig4, ax4 = plt.subplots(figsize=(5, 3))  # Adjusted plot size
...
ax4.set_xlabel('Index', fontsize=8)
ax4.set_ylabel('Credit Amount', fontsize=8)
...
fig5, ax5 = plt.subplots(figsize=(5, 3))  # Adjusted plot size
sns.boxplot(
...
ax5.set_title('Comparative Analysis of Credit and Debit Transactions by Account Type', fontsize=10)
ax5.set_xlabel('Account Type', fontsize=8)
ax5.set_ylabel ('Transaction Amount', fontsize=8)
ax5.legend(title='Transaction Type', fontsize=8)
...
if 'Time' in data.columns:
    ...
    if not data.empty:
        ...
        if not time_series.empty:
            fig6, ax6 = plt.subplots(figsize=(5, 3))  # Adjusted plot size
            ...
            ax6.set_title("Transaction Trends Over Time", fontsize=10)
            ax6.set_xlabel("Time", fontsize=8)
            ax6.set_ylabel("Transaction Amount", fontsize=8)
...
fig7, ax7 = plt.subplots(figsize=(5, 3))  # Adjusted plot size
customer_transactions.set_index('Account Type').plot(kind='bar', stacked=True, ax=ax7, color=[colors['dark_blue'], colors['slate_blue']])
ax7.set_title('Total Credit and Debit Amounts by Account Type', fontsize=10)
ax7.set_xlabel('Account Type', fontsize=8)
ax7.set_ylabel('Transaction Amount', fontsize=8)
ax7.legend(title='Transaction Type', fontsize=8)
